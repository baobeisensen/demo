...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/manage/css/adminstyle.css" media="all">
...
<div class="layui-layout layui-layout-admin" id="layui_layout">
	...
	<div class="layui-side layui-side-bg layui-larry-side" id="larry-side">
		...
		<ul class="layui-nav layui-nav-tree">
			<li class="layui-nav-item layui-this">
				<a href="javascript:;" data-url="/back/main">
	...
	<div class="layui-body" id="larry-body" style="bottom: 0;border-left: solid 2px #2299ee;">
		<div class="layui-tab layui-tab-card larry-tab-box" id="larry-tab" lay-filter="demo" lay-allowclose="true">
			...
			<div class="layui-tab-content" style="min-height: 150px; ">
				<div class="layui-tab-item layui-show" style="height: fit-content">
					<iframe class="larry-iframe" data-id='0' src="/back/main" style="height: -webkit-fill-available"></iframe>
				</div>
			</div>
		</div>
	</div>
...
<!-- 加载js文件-->                                                                                                                                                                                           
	...
	<script type="text/javascript" src="/manage/js/larry.js"></script>
...
<div class="lock-screen" style="display: none;">
	<div id="locker" class="lock-wrapper">
		...
		<div class="lock-box center">
			<img src="/manage/images/userimg.jpg" alt="">
			<h1>${user.name}</h1>
