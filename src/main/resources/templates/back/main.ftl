...
<head>
  ...
  <meta name="format-detection" content="telephone=no"> 
	...
	<link rel="stylesheet" type="text/css" href="/manage/common/global.css">
	<link rel="stylesheet" type="text/css" href="/manage/css/main.css" media="all">
</head>
<body>
				...
				<div class="panel-body" >
					<table class="table table-hover personal-task">
                         <tbody>
                         	<tr>
                         		<td>
                         			<strong>当前操作系统：</strong>
                         		</td>
                         		<td>
                                    <span id="editionClient"></span><br>
                         		</td>
                         	</tr>
                         	<tr>
                         		<td>
                         	...
                         	<tr>
                                ...
                                <td>mysql<span id="databaseSpan"></span></td>
                         	</tr>
                         	<tr>
                         		<td>
                                <strong>单次最大上传限制： </strong>

                                </td>
                                <td><span id="fileUpload"></span></td>
                         	</tr>
                         	<#--<tr>
                         		<td>
                                <strong>当前登录用户</strong>：
                                    <span class="current_user">${user.name}</span>
...
<script type="text/javascript" src="/manage/common/layui/layui.js"></script>
...
<script type="text/javascript" src="/manage/jsplug/echarts.min.js"></script>
